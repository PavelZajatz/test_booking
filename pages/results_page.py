...
class ResultPage(BasePage):
    ...
    # checking that calendar for specifying check in date is opened
    ...
    # checking that no result entry containing booking price or booking status
    ...
    # checking that each result entry has booking price or banner saying no free places
